...
$url_path = str_replace('\\', '/', $url_path);
    ...
    $styles = $scss->compile('@import "1731-styles.scss";');

    $css = fopen('css/1731-styles.css','w');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/1731-styles.css" rel="stylesheet" type="text/css" />
