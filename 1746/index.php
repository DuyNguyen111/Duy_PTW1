...
$url_path = str_replace('\\', '/', $url_path);
    ...
    $styles = $scss->compile('@import "1746-styles.scss";');

    $css = fopen('css/1746-styles.css','w');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/1746-styles.css" rel="stylesheet" type="text/css" />
